...
{
    [InitializeOnLoad]
    public class StocksButton : Stocks
    {
        private const string kElementPath = "Stocks Button";
        ...
        public static MainToolbarElement StockPriceButton()
        {
            ...
            return new MainToolbarButton(content, OnClickButton);
        }
        ...
        public static IEnumerator FetchStockPrice()
        {
            ...
            string apiKey = EditorPrefs.GetString(ApiKeyPrefKey, string.Empty); // cu9scohr01qkpes3k8o0cu9scohr01qkpes3k8og
